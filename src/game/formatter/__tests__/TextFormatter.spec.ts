...
describe('TextFormatter', () => {
    ...
    it('should do nothing with templateless text ', () => {
        ...
        const actualValue = unitUnderTest.formateTemplateText(templatelessText);
    ...
    it('should replace one templatePart with proper value', () => {
        ...
        const actualValue = unitUnderTest.formateTemplateText(oneTemplatePartText);
    ...
    it('should replace two templateParts with proper values', () => {
        ...
        const actualValue = unitUnderTest.formateTemplateText(twoTemplatePartText);
    ...
    it('should replace templatePart with fallback value and log lack of value', () => {
        ...
        const actualValue = unitUnderTest.formateTemplateText(templatePartText);
